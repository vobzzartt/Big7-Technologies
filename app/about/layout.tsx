...
export const metadata: Metadata = {
  ...
  description: 'Founded by Victor Bodude, Big7 Technologies is building the core foundational layers of African infrastructure to break the cycle of foreign tech dependency.',
  openGraph: {
