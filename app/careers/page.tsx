...
const jobOpenings = [
    ...
    },
    {
        ...
        description: "Design decentralized systems, smart contracts, and sovereign protocol layers using modern cryptographic frameworks.",
        requirements: ["Proficiency in Rust", "Deep understanding of blockchain protocols", "Solidity/Smart Contract experience"],
        icon: <Layers className="size-5" />
    },
    {
        title: "Frontend Intern",
        description: "Collaborate on building high-fidelity, performance-optimized interfaces for our sovereign cloud and research portals.",
        requirements: ["Proficiency in React & TypeScript", "Minimum 3 years relevant experience", "Eye for detail and premium UI/UX"],
            ...
            <main className="min-h-screen pt-24 md:pt-32 pb-24">
                <div className="mx-auto max-w-5xl px-6 space-y-24">
                    ...
                    <div className="space-y-6 text-center">
                        ...
                        <h1 className="text-4xl md:text-6xl font-bold tracking-tight">Engineering the Future.</h1>
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                            We are looking for exceptional engineers to build the foundational layers of sovereign infrastructure and distributed systems.
                        </p>
                    </div>
                            ...
                            >
                                <div className="grid md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Input name="email" type="email" placeholder="hello@big7technologies.com" required className="bg-background border-muted/50" />
                                    </div>
                                </div>
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-bold uppercase tracking-widest ml-1">Why Big7?</label>
                                    <Textarea name="motivation" placeholder="Tell us why you're interested in building sovereign systems..." required className="bg-background border-muted/50 min-h-[120px]" />
                                </div>

                                <div className="space-y-2">
                                    <label className="text-[10px] font-bold uppercase tracking-widest ml-1">How can you contribute?</label>
                                    <Textarea name="contribution" placeholder="Describe a specific systems challenge you want to solve here..." required className="bg-background border-muted/50 min-h-[120px]" />
                                </div>
