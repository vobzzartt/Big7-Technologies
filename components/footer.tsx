...
const navLinks = [
    { title: 'Home', href: '/' },
    { title: 'Research', href: 'https://research.big7technologies.com' },
...
const solutionLinks = [
    { title: 'Distributed Systems', href: '/research#distributed' },
    { title: 'Applied Physics', href: '/research#physics' },
    { title: 'Sovereign AI', href: '/research#ai' }
]
...
const socialLinks = [
    {
        name: "X",
        href: "https://x.com/big7technologies",
        icon: (
    ...
    {
        name: "GitHub",
        href: "https://github.com/big7technologies",
        icon: (
    ...
    {
        name: "LinkedIn",
        href: "https://linkedin.com/company/big7technologies",
        icon: (
    ...
    {
        name: "Instagram",
        href: "https://instagram.com/big7technologies",
        icon: (
        ...
        <footer className="relative z-10 border-t bg-white py-12 dark:bg-transparent">
            <div className="mx-auto max-w-5xl px-6 flex flex-col items-center gap-8">
                ...
                <div className="flex flex-col items-center gap-4 border-t border-b py-8 w-full max-w-4xl">
                    <p className="text-sm text-muted-foreground font-medium uppercase tracking-widest">Contact the Lab</p>
                    <a href="mailto:hello@big7technologies.com" className="text-xl md:text-2xl font-bold hover:text-primary transition-colors">
                ...
                <div className="w-full mt-8 flex flex-col gap-4">
                    <span className="block text-center text-sm text-muted-foreground">
                        © {new Date().getFullYear()} Big7 Technologies. Engineering the future from Africa.
                    </span>
                </div>
            </div>
        </footer>
