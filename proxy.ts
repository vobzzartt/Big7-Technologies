...
const buildContentSecurityPolicy = (nonce: string) =>
  [
    ...
    "frame-src 'self' https://prod.spline.design https://my.spline.design https://unpkg.com https://cdn.jsdelivr.net https://big7technologies.com https://www.youtube.com https://www.youtube-nocookie.com;",
    "object-src 'none';",
    "base-uri 'self';",
